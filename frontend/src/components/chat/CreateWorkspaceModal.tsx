  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl border border-white/8 bg-[#111114] px-8 py-7 shadow-xl">
        <h2 className="text-lg font-semibold text-white/90 mb-1">Create a workspace</h2>
        <p className="text-[13px] text-white/40 mb-6">Give your workspace a name to get started.</p>
