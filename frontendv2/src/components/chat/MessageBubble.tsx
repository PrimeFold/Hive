      ...
      <div className={cn("max-w-[68%] flex flex-col gap-1", self ? "items-end" : "items-start")}>
        {!grouped && (
          <div className="flex items-center gap-2 px-1">
            <span className="text-[12.5px] font-semibold text-foreground/90">{message.username}</span>
        ...
        <div
          className={cn(
            ...
            self
              ...
              : "bg-white/[0.05] backdrop-blur border border-white/[0.06] text-foreground rounded-2xl rounded-bl-md hover:bg-white/[0.07]"
          )}
        >
          {message.text}
        </div>
